      ...
      <div className="p-4 space-y-4">
        <div className="bg-slate-50 dark:bg-slate-700 p-3 rounded-lg">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
            <div>
              <strong className="text-slate-600 dark:text-slate-400">{t.date}:</strong>{' '}
              <span className="text-slate-800 dark:text-slate-200">
                {formatDate(recordToEdit.date)}
              </span>
            </div>
            <div>
              <strong className="text-slate-600 dark:text-slate-400">{t.unit}:</strong>{' '}
              <span className="text-slate-800 dark:text-slate-200">{recordToEdit.unit}</span>
            </div>
            <div>
              <strong className="text-slate-600 dark:text-slate-400">{t.start_time}:</strong>{' '}
              <span className="text-slate-800 dark:text-slate-200 font-mono">
                {recordToEdit.start_time}
              </span>
            </div>
            <div>
              <strong className="text-slate-600 dark:text-slate-400">{t.end_time}:</strong>{' '}
              <span className="text-slate-800 dark:text-slate-200 font-mono">
                {recordToEdit.end_time}
              </span>
            </div>
            <div className="sm:col-span-2">
              <strong className="text-slate-600 dark:text-slate-400">{t.problem}:</strong>{' '}
              <span className="text-slate-800 dark:text-slate-200">{recordToEdit.problem}</span>
            </div>
          </div>
        </div>
