        ...
        <table className="w-full text-xs min-w-max">
          ...
          <tbody>
            {operatorData.map((operator, index) => (
              ...
              >
                <td className="px-2 py-2 font-medium text-slate-900 dark:text-slate-100 border-r border-slate-200 dark:border-slate-600">
                  {operator.shift}
                </td>
                <td className="px-2 py-2 text-slate-800 dark:text-slate-200">{operator.name}</td>
              </tr>
            ))}
          </tbody>
        </table>
