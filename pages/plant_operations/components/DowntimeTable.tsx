        ...
        <table className="w-full text-xs min-w-max">
          <thead>
            <tr className="bg-gradient-to-r from-rose-100 to-pink-100 dark:from-rose-900/30 dark:to-pink-900/30">
              ...
              <th className="px-2 py-3.5 text-left font-semibold text-slate-800 dark:text-slate-200 align-middle">
                {t.problem || 'Problem'}
              </th>
            </tr>
          </thead>
            ...
            {downtimeData && downtimeData.length > 0 ? (
              downtimeData.map((downtime, index) => {
                ...
                return (
                  ...
                  >
                    <td className="px-2 py-3.5 text-slate-800 dark:text-slate-200 border-r border-slate-200 dark:border-slate-600 align-middle">
                      {downtime.start_time}
                    </td>
                    <td className="px-2 py-3.5 text-slate-800 dark:text-slate-200 border-r border-slate-200 dark:border-slate-600 align-middle">
                      {downtime.end_time}
                    ...
                    <td className="px-2 py-3.5 text-slate-800 dark:text-slate-200 max-w-xs align-middle">
