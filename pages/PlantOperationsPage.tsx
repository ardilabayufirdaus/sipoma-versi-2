...
const PlantOperationsPage: React.FC<PlantOperationsPageProps> = ({ activePage, t, plantData }) => {
  ...
  switch (activePage) {
    ...
    case 'op_monitoring':
      return <Monitoring downtimeData={getAllDowntime()} riskData={riskRecords} t={t} />;
    default:
