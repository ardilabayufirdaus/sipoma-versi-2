...
export const ResponsiveGrid: React.FC<ResponsiveGridProps> = ({
  ...
  const getGridCols = (breakpoint: string) => {
    const colCount =
      columns[breakpoint as keyof typeof columns] || columns.default;
...
export const ResponsiveFlex: React.FC<ResponsiveFlexProps> = ({
  ...
  const getDirectionClass = (breakpoint: string) => {
    const dir =
      direction[breakpoint as keyof typeof direction] || direction.default;
...
export const ResponsiveSidebar: React.FC<ResponsiveSidebarProps> = ({
  ...
  const getWidth = () => {
    if (breakpoint === "lg" || breakpoint === "xl")
      return width.lg || width.md || width.default;
...
export const ResponsiveHeader: React.FC<ResponsiveHeaderProps> = ({
  ...
  const getHeight = () => {
    if (breakpoint === "sm" || breakpoint === "xs")
      return height.sm || height.default;
