...
export const useWorkInstructions = () => {
  ...
  const addInstruction = useCallback(async (instruction: Omit<WorkInstruction, 'id'>) => {
  ...
  const updateInstruction = useCallback(async (updatedInstruction: WorkInstruction) => {
