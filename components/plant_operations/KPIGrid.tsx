...
import { PlantOperationsStats, DashboardKPI } from '../../hooks/usePlantOperationsDashboard';
...
const KPICard = React.memo<DashboardKPI & { formatNumber: (num: number) => string }>(
...
const KPIGrid: React.FC<KPIGridProps> = React.memo(({ plantOperationsStats, formatNumber }) => {
