    ...
    {chartType === 'line' || chartType === 'combo' ? (
      <ResponsiveLine
        ...
        sliceTooltip={({ slice }) => (
          ...
          >
            <div className="font-semibold mb-1 text-xs">Day {slice.points[0].data.x}</div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex justify-between items-center">
                        <span className="truncate mr-2" style={{ maxWidth: '80px' }}>
                          {serieId.length > 10 ? serieId.substring(0, 10) + '...' : serieId}
                        </span>
      ...
      <ResponsiveBar
        data={performanceData.chartData[performanceData.displayedAreas[0]]?.map((d, index) => {
          ...
          return (
            ...
            >
              <div className="font-semibold text-xs">
                {serieId.length > 12 ? serieId.substring(0, 12) + '...' : serieId}
              </div>
              ...
              <div key={area} className="flex items-center justify-between gap-2">
                <div className="flex items-center flex-1 min-w-0">
                  <span
                    ...
                    style={{
                      backgroundColor:
                        COLORS[performanceData.displayedAreas.indexOf(area) % COLORS.length],
                    }}
                  ></span>
