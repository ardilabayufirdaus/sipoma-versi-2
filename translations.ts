export const translations = {
  en: {
    ...
    dashboard_welcome_subtitle:
      "Your central hub for cement manufacturing management. Here's a quick overview of the system.",
    ...
    link_user_management: "Manage Users",
    link_plant_dashboard: "View Plant Dashboard",
    link_packing_data_entry: "Stock Data Entry",
    link_project_board: "Go to Project Board",

    // Settings Page
    settings_page_subtitle:
      "Manage your account preferences and profile details here.",
    ...
    push_notifications_project_desc:
      "Get push notifications for upcoming project task deadlines.",
    ...
    no_downtime_for_month:
      "No downtime incidents recorded for the selected month.",
  ...
  id: {
    ...
    link_user_management: "Kelola Pengguna",
    ...
    // Settings Page
    settings_page_subtitle:
      "Kelola preferensi akun dan detail profil Anda di sini.",
    ...
    upload_avatar_error_type:
      "File harus berupa gambar (JPEG, PNG, GIF, atau WebP)",
    ...
    module_user_management: "Manajemen Pengguna",
    ...
    permission_level_write: "Lihat & Tulis",
    permission_level_admin: "Admin",
    ...
    user_created_success_message:
      "Akun telah berhasil dibuat. Bagikan kredensial ini dengan aman.",
    ...
    report_generated_success:
      "Laporan berhasil dibuat. Anda sekarang dapat mengunduhnya.",
    no_report_parameters:
      "Tidak ada parameter laporan yang diatur di Data Master.",
    ...
    alert_mill_vibration:
      "Sensor getaran di Mill 1 melaporkan pembacaan tinggi.",
    ...
    no_downtime_for_month:
      "Tidak ada insiden downtime yang tercatat untuk bulan yang dipilih.",
    ...
    forecast_stdev: "StDev",
    forecast_no_data:
      "Data tidak cukup untuk membuat perkiraan untuk area ini.",
